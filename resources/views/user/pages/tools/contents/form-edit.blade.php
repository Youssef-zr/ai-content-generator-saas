...
<div class="row">
    <!-- prompt description -->
    <div class="col-12">
        <div class="bg-info d-inline-block mb-3 px-3 py-2 rounded">
            ...
            <div class="card-body">
                <form class="cmxform" id="formValidation">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('tone_id', $tones, $content->data['tone_id'], ['class' => 'form-control']) !!}
                    </div>

                    <!-- language field -->
                    <div class="form-group">
                        {!! Form::label('language_id', 'Language', ['class' => 'form-label']) !!}
                        {!! Form::select('language_id', $langs, old('language_id', $content->data['language_id']), [
                            'class' => 'form-control',
                        ]) !!}
                    </div>
    ...
    <div class="col-md-6">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                {!! Form::textarea('content', $content->data['content'], [
    ...
    <script>
        $(() => {
            ...
            let formData = () => {
                ...
                let inputs = {
                    content_id: Number($('input[name="content_id"]').val()),
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        ...
                        new Noty({
                            ...
                            "type": "success",
                            "layout": 'topRight',
                            "text": "<span>Content updated successfully <i class='fa fa-smile-o'></i></span>",
                            "timeout": 2000,
                            "killer": true,
                            "progressBar": true,
                        }).show();
            ...
            let copyTextToClipboard = () => {
                let content = $textareaContent.text();
            ...
            const downloadFile = () => {
                const content = $textareaContent.val();
