...
class SettingController extends Controller
{
    ...
    {
        $this->middleware('permission:update_brand', ['only' => ['brand_show','brand_update','update_image']]);
        $this->middleware('permission:update_third_party', ['only' => ['third_party_show','update_open_ai_key','update_paypal_settings']]);
        $this->middleware('permission:update_content', ['only' => ['content_show','content_update']]);
