...
class EngineController extends Controller
{
    ...
    {
        $this->middleware('permission:access_engine')->only('index');
        $this->middleware('permission:create_engine')->only(['create', 'store']);
        $this->middleware('permission:update_engine')->only(['edit', 'update']);
        $this->middleware('permission:read_engine')->only('show');
        $this->middleware('permission:delete_engine')->only(['delete', 'delete-all']);
    }
